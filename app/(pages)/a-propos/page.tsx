  ...
  return (
    <article className="space-y-5 animate-fade-slide-up">
      ...
      <div className="space-y-4 text-sm leading-relaxed text-gray-600">
        <p>
          exerceō est une application éducative pensée pour accompagner les
        ...
        <p>
          L'objectif d'exerceō est de rendre les exercices courts, accessibles
        ...
        <div className="rounded-2xl p-5 space-y-3" style={{ backgroundColor: "#f5f9ff" }}>
          <p className="font-bold text-sm" style={{ color: "#071453" }}>
            exerceō a été conçu avec trois principes simples :
          </p>
        ...
        <div className="rounded-2xl p-5 space-y-3 border border-gray-200" style={{ backgroundColor: "#fffdf5" }}>
          <p className="font-bold text-sm" style={{ color: "#071453" }}>
            exerceō est un outil complémentaire à la scolarité, et ne la remplace pas.
          </p>
          <p>
            Les exercices proposés dans exerceō sont élaborés à partir des attendus officiels
          ...
          <ul className="space-y-1.5">
            {[
              ...
              "Certaines notions ne sont parfois vues qu'en milieu ou en fin d'année, alors qu'exerceō peut déjà proposer des exercices correspondants.",
            ].map((item) => (
          ...
          <p>
            exerceō doit être considéré comme un support d'entraînement et de révision,
